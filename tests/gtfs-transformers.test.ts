...
const fixtures = {
  carris: jsonAs<GtfsFixture>(readFileSync(new URL("./fixtures/gtfs/carris-metropolitana.json", import.meta.url), "utf8")),
  metro: jsonAs<GtfsFixture>(readFileSync(new URL("./fixtures/gtfs/metro-do-porto.json", import.meta.url), "utf8")),
};
