...
import { marketPeriodStart, OmieTransformer } from "../apps/gatekeeper/src/publishers/omie/omie/transform";
...
function oneRowFile(series: Series, date: string, row: string): string {
