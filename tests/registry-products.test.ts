...
function entry(slug: string, kind: "record" | "series", chunks: ManifestChunk[] | null): ProductIndexEntry {
  return {
    id: `prd_${slug}`, slug, feedId: "feed_1", productKey: slug, title: slug, description: "", role: kind === "series" ? "time-series" : "reference", kind,
    schema: { fields: [] }, updateMode: "authoritative-snapshot", completeness: "complete", version: 1, status: "current", currentAcquisitionId: "acq_1",
    watermark: null, rowCount: 2, chunks, changesKey: null, seriesKey: null, seriesChangesKey: null,
    updatedAt: "2026-09-11T00:00:00.000Z", createdAt: "2026-09-11T00:00:00.000Z",
  };
}
