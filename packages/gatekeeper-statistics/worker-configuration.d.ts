/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=packages/gatekeeper-statistics/wrangler.jsonc packages/gatekeeper-statistics/worker-configuration.d.ts` (hash: 0656c794b6b3be8e4afd0d75038409f2)
// Runtime types generated with workerd@1.20260903.1 2026-09-09 nodejs_compat
interface __BaseEnv_Env {
	INE_API_ORIGIN: "https://www.ine.pt";
	BPSTAT_API_ORIGIN: "https://bpstat.bportugal.pt";
	EUROSTAT_API_ORIGIN: "https://ec.europa.eu";
	UDATA_ALLOWED_HOSTS: "dados.gov.pt";
	OGC_ALLOWED_HOSTS: "ogcapi.dgterritorio.gov.pt,ambiente.azores.gov.pt";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "INE_API_ORIGIN" | "BPSTAT_API_ORIGIN" | "EUROSTAT_API_ORIGIN" | "UDATA_ALLOWED_HOSTS" | "OGC_ALLOWED_HOSTS">> {}
}
