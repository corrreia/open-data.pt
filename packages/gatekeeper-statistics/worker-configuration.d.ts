/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=packages/gatekeeper-statistics/wrangler.jsonc packages/gatekeeper-statistics/worker-configuration.d.ts` (hash: 4dff9c7b46f8114f66f89b2d32cc51df)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "INE_API_ORIGIN" | "BPSTAT_API_ORIGIN" | "EUROSTAT_API_ORIGIN">> {}
}
