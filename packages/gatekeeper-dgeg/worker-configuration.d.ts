/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=packages/gatekeeper-dgeg/wrangler.jsonc packages/gatekeeper-dgeg/worker-configuration.d.ts` (hash: 50e5d720f19071a16b0f0d2730c31c00)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DGEG_API_ORIGIN">> {}
}
