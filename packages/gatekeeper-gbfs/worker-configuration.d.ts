/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=packages/gatekeeper-gbfs/wrangler.jsonc packages/gatekeeper-gbfs/worker-configuration.d.ts` (hash: 6930d6c46f33e70ee125e77dc77671ee)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GBFS_ALLOWED_HOSTS">> {}
}
