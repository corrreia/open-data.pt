...
export const CATALOG_EXAMPLES: ExampleFeed[] = [
  dataset(
    "bpstat-banknotes-issued",
    "Euro banknotes put into circulation by Banco de Portugal",
    ...
    "9",
    "002abf63d5a4efb3e35ab5321251d7c5",
    [12468838, 12468839],
    60,
  ),
  dataset(
    "bpstat-construction-business-financial-health",
    "Construction-sector business financial health",
  ...
  dataset(
    ...
    "22",
    "471186a839daf97d9280419fc06c8579",
    [12504589, 12504590, 12504591],
    366,
    86_400,
  ),
  ...
  dataset(
    "bpstat-goods-trade-growth",
    "Growth in Portuguese exports and imports of goods",
    ...
    "53",
    "34e4f2e4ddae13cba3e74c926fc23f48",
    [12587117, 12587123],
    60,
  ),
  dataset(
    "bpstat-household-indebtedness",
    "Household indebtedness and loan growth",
  ...
  dataset(
    ...
    "New car-loan contract amount percentiles",
  ...
  dataset(
    ...
    "Portuguese Treasury-bond yields",
  ...
  dataset(
    "bpstat-government-deposit-assets",
    "Regional, local government and social-security deposits",
    ...
    "28",
    "10470e6b60c710218dd2a0e6a20fb040",
    [13168814, 13168815, 13168816],
    60,
  ),
  dataset(
    "bpstat-emigrant-deposits-by-region",
    "Emigrant deposits by Portuguese NUTS II region",
  ...
  dataset(
    ...
    "Household borrowers with overdue loans by region and purpose",
