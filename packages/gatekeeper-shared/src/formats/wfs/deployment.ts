...
export const WFS_DEPLOYMENT: LibraryDeployment<{ readonly WFS_ALLOWED_HOSTS: string }> = {
  ...
  vars: { WFS_ALLOWED_HOSTS: "maps.effis.emergency.copernicus.eu,api.sgifr.gov.pt,oeirasinterativa.oeiras.pt,servicos.dgterritorio.pt,geo2.dgterritorio.gov.pt" },
  cpuMs: 120_000,
  library: (env) => ({
