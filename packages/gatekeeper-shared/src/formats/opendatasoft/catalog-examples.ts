...
export const CATALOG_EXAMPLES: ExampleFeed[] = [
  energy(
    ...
    "Electricity service continuity by municipality",
  ...
  energy(
    "e-redes-municipal-monthly-consumption-feed",
    "Monthly electricity consumption by municipality and voltage",
  ...
  energy(
    "e-redes-active-smart-meter-contracts-feed",
    "Active electricity contracts by meter type and district",
  ...
  energy(
    "e-redes-municipal-contracted-capacity-feed",
    "Contracted electricity capacity by municipality",
  ...
  energy(
    "e-redes-contracts-by-power-band-feed",
    "Electricity contracts by district and power band",
  ...
  energy(
    ...
    "Distribution transformer stations by municipality",
  ...
  energy(
    "e-redes-self-consumption-exported-energy-feed",
    "Energy exported by self-consumption installations",
  ...
  energy(
    ...
    "Historical hourly electricity consumption in postal areas 1000 and 4000",
  ...
  energy(
    "e-redes-monthly-postal-consumption-feed",
    "Monthly electricity consumption by four-digit postal area",
  ...
  energy(
    "e-redes-municipal-tariff-consumption-feed",
    "Municipal electricity consumption by tariff period",
  ...
  energy(
    ...
    "Public street lighting by municipality and lamp type",
  ...
  health(
    ...
    "Public health-sector contracts",
  ...
  health(
    "sns-psychology-consultations-feed",
    "Psychology consultations by hospital",
  ...
  health(
    "sns-medicine-package-prices-feed",
    "Average medicine-package prices",
  ...
  health(
    ...
    "Sickness self-declarations by channel, sex and age",
  ...
  health(
    "sns-emergency-calls-transferred-sns24-feed",
    "Emergency calls transferred to SNS 24",
  ...
  health(
    ...
    "Historical blood collection by institution and blood group",
  ...
  health(
    "sns-generic-medicine-dispensing-feed",
    "Generic medicine dispensing and market share",
  ...
  health(
    "sns-supplier-debt-and-arrears-feed",
    "Health-service supplier debt and payment arrears",
  ...
  health(
    "sns-pregnancy-line-triage-feed",
    "SNS Grávida pregnancy-line triage",
  ...
  health(
    "sns-poison-information-calls-feed",
    "Poison information centre calls",
  ...
  health(
    ...
    "Licensed public-space defibrillator programmes",
  ...
  health(
    ...
    "Medical specialty training vacancies",
  ...
  health(
    "sns-hospital-beds-by-type-feed",
    "Acute hospital beds by type",
  ...
  health(
    ...
    "Environmental Legionella monitoring",
  ...
  health(
    "sns-lvt-hospital-morbidity-mortality-feed",
    "Reported hospital morbidity and mortality figures in Lisbon and Tagus Valley",
  ...
  health(
    "sns-first-consultations-within-target-feed",
    "First hospital consultations within the response target",
