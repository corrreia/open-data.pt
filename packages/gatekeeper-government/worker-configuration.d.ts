/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=packages/gatekeeper-government/wrangler.jsonc packages/gatekeeper-government/worker-configuration.d.ts` (hash: 259e401fbd4c7e6c3e9d4063ac9cecef)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "UDATA_ALLOWED_HOSTS">> {}
}
