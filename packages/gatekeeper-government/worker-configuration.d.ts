/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=packages/gatekeeper-government/wrangler.jsonc packages/gatekeeper-government/worker-configuration.d.ts` (hash: 2ed3ef35c17751f5f185b4a3cce16f60)
