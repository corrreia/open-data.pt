/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=packages/gatekeeper-carris/wrangler.jsonc packages/gatekeeper-carris/worker-configuration.d.ts` (hash: 0ad55c7e5951ac9c56ebbb0de30eda8a)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CARRIS_API_ORIGIN">> {}
}
