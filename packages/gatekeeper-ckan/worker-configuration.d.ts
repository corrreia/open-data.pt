/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=packages/gatekeeper-ckan/wrangler.jsonc packages/gatekeeper-ckan/worker-configuration.d.ts` (hash: 5e729e0aba1cbfdfe5d78bb885c8adda)
// Runtime types generated with workerd@1.20260903.1 2026-09-09 nodejs_compat
interface __BaseEnv_Env {
	CKAN_ALLOWED_HOSTS: "dadosabertos.cm-porto.pt,dadosabertos.cascais.pt,dadosabertos.cm-agueda.pt,oeirasinterativa.oeiras.pt";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CKAN_ALLOWED_HOSTS">> {}
}
