/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=packages/gatekeeper-metrolisboa/wrangler.jsonc packages/gatekeeper-metrolisboa/worker-configuration.d.ts` (hash: 789107a9fb7d84a52f042d17b0652a29)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "METROLISBOA_API_ORIGIN">> {}
}
