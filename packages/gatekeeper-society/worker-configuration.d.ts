/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=packages/gatekeeper-society/wrangler.jsonc packages/gatekeeper-society/worker-configuration.d.ts` (hash: 1e34d659cec8b4bd649e6ba8ada5c616)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "INE_API_ORIGIN" | "OGC_ALLOWED_HOSTS" | "UDATA_ALLOWED_HOSTS">> {}
}
