/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=packages/gatekeeper-mobility/wrangler.jsonc packages/gatekeeper-mobility/worker-configuration.d.ts` (hash: 0e7bf33003c5e11919586c7cdd15ec21)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CARRIS_API_ORIGIN" | "GBFS_ALLOWED_HOSTS" | "GTFS_ALLOWED_HOSTS" | "INE_API_ORIGIN" | "METROLISBOA_API_ORIGIN">> {}
}
