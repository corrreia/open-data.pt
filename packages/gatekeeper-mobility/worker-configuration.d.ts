/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=packages/gatekeeper-mobility/wrangler.jsonc packages/gatekeeper-mobility/worker-configuration.d.ts` (hash: 6299b42005fe78349b22048cacd13b2e)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CARRIS_API_ORIGIN" | "METROLISBOA_API_ORIGIN" | "GTFS_ALLOWED_HOSTS" | "GBFS_ALLOWED_HOSTS">> {}
}
