/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=packages/gatekeeper-mobility/wrangler.jsonc packages/gatekeeper-mobility/worker-configuration.d.ts` (hash: 09c739be1b801628591ff7cf3b9d4b19)
