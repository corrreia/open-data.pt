/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=packages/gatekeeper-mobility/wrangler.jsonc packages/gatekeeper-mobility/worker-configuration.d.ts` (hash: 767f597d443bbe36727acb900ef3c0e2)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CARRIS_API_ORIGIN" | "METROLISBOA_API_ORIGIN" | "GTFS_ALLOWED_HOSTS" | "GBFS_ALLOWED_HOSTS" | "INE_API_ORIGIN">> {}
}
