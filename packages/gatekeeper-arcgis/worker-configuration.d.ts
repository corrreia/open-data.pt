/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=packages/gatekeeper-arcgis/wrangler.jsonc packages/gatekeeper-arcgis/worker-configuration.d.ts` (hash: 12b58c73f5e8288bf069d510145088db)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ARCGIS_ALLOWED_HOSTS">> {}
}
