/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=packages/gatekeeper-eurostat/wrangler.jsonc packages/gatekeeper-eurostat/worker-configuration.d.ts` (hash: 04ae77cdbe62ee9f8ecc86e41fe6f5f2)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "EUROSTAT_API_ORIGIN">> {}
}
