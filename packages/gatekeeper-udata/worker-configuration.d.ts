/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=packages/gatekeeper-udata/wrangler.jsonc packages/gatekeeper-udata/worker-configuration.d.ts` (hash: 2ed3ef35c17751f5f185b4a3cce16f60)
