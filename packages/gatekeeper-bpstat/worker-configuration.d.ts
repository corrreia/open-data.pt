/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=packages/gatekeeper-bpstat/wrangler.jsonc packages/gatekeeper-bpstat/worker-configuration.d.ts` (hash: bcd1e2922589a00b4a053fe71b096ed7)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BPSTAT_API_ORIGIN">> {}
}
