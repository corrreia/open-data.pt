/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=packages/gatekeeper-environment/wrangler.jsonc packages/gatekeeper-environment/worker-configuration.d.ts` (hash: 974f0b4fcd40cb1e1174d3db37e1273f)
// Runtime types generated with workerd@1.20260903.1 2026-09-09 nodejs_compat
interface __BaseEnv_Env {
	IPMA_API_ORIGIN: "https://api.ipma.pt";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "IPMA_API_ORIGIN" | "ARCGIS_ALLOWED_HOSTS" | "OGC_ALLOWED_HOSTS">> {}
}
