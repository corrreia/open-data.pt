/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=packages/gatekeeper-environment/wrangler.jsonc packages/gatekeeper-environment/worker-configuration.d.ts` (hash: 44da0e18d784c2d0f6d02c6c83a11d26)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ARCGIS_ALLOWED_HOSTS" | "IPMA_API_ORIGIN" | "OGC_ALLOWED_HOSTS">> {}
}
