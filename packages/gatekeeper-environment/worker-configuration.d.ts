/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=packages/gatekeeper-environment/wrangler.jsonc packages/gatekeeper-environment/worker-configuration.d.ts` (hash: 3c23c208b789390005bc26cffb246bc6)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "IPMA_API_ORIGIN" | "ARCGIS_ALLOWED_HOSTS">> {}
}
