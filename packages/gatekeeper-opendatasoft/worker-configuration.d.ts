/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=packages/gatekeeper-opendatasoft/wrangler.jsonc packages/gatekeeper-opendatasoft/worker-configuration.d.ts` (hash: 2eb53e8adc4c70cc5cdc62ea50ed900c)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OPENDATASOFT_ALLOWED_HOSTS">> {}
}
