/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=packages/gatekeeper-omie/wrangler.jsonc packages/gatekeeper-omie/worker-configuration.d.ts` (hash: bd947e2444cd13920a6e9a613cb46dd6)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OMIE_API_ORIGIN">> {}
}
