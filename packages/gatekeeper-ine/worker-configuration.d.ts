/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=packages/gatekeeper-ine/wrangler.jsonc packages/gatekeeper-ine/worker-configuration.d.ts` (hash: 9ffc64b115ba23a012b1a549e6f34f86)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "INE_API_ORIGIN">> {}
}
