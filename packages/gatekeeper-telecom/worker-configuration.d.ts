/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=packages/gatekeeper-telecom/wrangler.jsonc packages/gatekeeper-telecom/worker-configuration.d.ts` (hash: ad81b0b0ebd67c8ff56b1e149ec704a4)
// Runtime types generated with workerd@1.20260903.1 2026-09-09 nodejs_compat
interface __BaseEnv_Env {
	INE_API_ORIGIN: "https://www.ine.pt";
	PEERINGDB_API_ORIGIN: "https://www.peeringdb.com";
	RIPESTAT_API_ORIGIN: "https://stat.ripe.net";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "INE_API_ORIGIN" | "PEERINGDB_API_ORIGIN" | "RIPESTAT_API_ORIGIN">> {}
}
