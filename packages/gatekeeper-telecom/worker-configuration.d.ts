/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=packages/gatekeeper-telecom/wrangler.jsonc packages/gatekeeper-telecom/worker-configuration.d.ts` (hash: 7ea0c3bf0ff37311c4286332ab53947d)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "INE_API_ORIGIN" | "RIPESTAT_API_ORIGIN" | "PEERINGDB_API_ORIGIN">> {}
}
