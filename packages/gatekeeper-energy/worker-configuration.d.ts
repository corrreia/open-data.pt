/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=packages/gatekeeper-energy/wrangler.jsonc packages/gatekeeper-energy/worker-configuration.d.ts` (hash: d3add40a201ae3c24d5d79dfc1cb6111)
...
interface __BaseEnv_Env {
	...
	OPENDATASOFT_ALLOWED_HOSTS: "e-redes.opendatasoft.com,transparencia.sns.gov.pt";
	REN_API_ORIGIN: "https://datahub.ren.pt";
	REN_DATA_API_ORIGIN: "https://servicebus.ren.pt";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DGEG_API_ORIGIN" | "EUROSTAT_API_ORIGIN" | "OMIE_API_ORIGIN" | "OPENDATASOFT_ALLOWED_HOSTS" | "REN_API_ORIGIN" | "REN_DATA_API_ORIGIN">> {}
}
