/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=packages/gatekeeper-energy/wrangler.jsonc packages/gatekeeper-energy/worker-configuration.d.ts` (hash: 1bda8d535a7dce3c58efac3ae1339cee)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "REN_API_ORIGIN" | "OMIE_API_ORIGIN" | "DGEG_API_ORIGIN" | "OPENDATASOFT_ALLOWED_HOSTS">> {}
}
