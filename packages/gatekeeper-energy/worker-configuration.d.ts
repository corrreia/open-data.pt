/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=packages/gatekeeper-energy/wrangler.jsonc packages/gatekeeper-energy/worker-configuration.d.ts` (hash: 0c874d5d06e068094d4e46b8d971c5be)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "REN_API_ORIGIN" | "REN_DATA_API_ORIGIN" | "OMIE_API_ORIGIN" | "DGEG_API_ORIGIN" | "OPENDATASOFT_ALLOWED_HOSTS" | "EUROSTAT_API_ORIGIN">> {}
}
