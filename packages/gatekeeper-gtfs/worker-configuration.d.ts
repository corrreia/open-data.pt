/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=packages/gatekeeper-gtfs/wrangler.jsonc packages/gatekeeper-gtfs/worker-configuration.d.ts` (hash: 793c1e4b9b4ec89b455bdb9f316d5396)
