/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=packages/gatekeeper-gtfs/wrangler.jsonc packages/gatekeeper-gtfs/worker-configuration.d.ts` (hash: 392830872319794c376d1b11b5fde236)
// Runtime types generated with workerd@1.20260903.1 2026-09-09 nodejs_compat
interface __BaseEnv_Env {
	GTFS_ALLOWED_HOSTS: "api.carrismetropolitana.pt,dadosabertos.cm-porto.pt,dados.gov.pt,publico.cp.pt,www.fertagus.pt,www.metrodoporto.pt,www.tub.pt,backend.tcbarreiro.pt,www.horariosdofunchal.pt";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GTFS_ALLOWED_HOSTS">> {}
}
