/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=packages/gatekeeper-gtfs/wrangler.jsonc packages/gatekeeper-gtfs/worker-configuration.d.ts` (hash: a53b21299ebc151567821ccd60345ed9)
