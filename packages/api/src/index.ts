...
/** A feed as `/api/feeds` serves it: what it is, whose it is and under what terms, how often it is read, and how its collection is going. */
export interface Feed {
  ...
  attribution?: string;
  /** Topic keys: what the catalog groups and filters by. */
  topics: string[];
