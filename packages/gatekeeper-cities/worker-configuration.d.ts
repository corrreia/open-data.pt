/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=packages/gatekeeper-cities/wrangler.jsonc packages/gatekeeper-cities/worker-configuration.d.ts` (hash: d50a1333a54bc63fe67a85e2aea63a1a)
// Runtime types generated with workerd@1.20260903.1 2026-09-09 nodejs_compat
interface __BaseEnv_Env {
	ARCGIS_ALLOWED_HOSTS: "services.arcgis.com,sniambgeoogc.apambiente.pt";
	CKAN_ALLOWED_HOSTS: "opendata.porto.digital,dadosabertos.cascais.pt,dadosabertos.cm-agueda.pt,oeirasinterativa.oeiras.pt";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ARCGIS_ALLOWED_HOSTS" | "CKAN_ALLOWED_HOSTS" | "UDATA_ALLOWED_HOSTS">> {}
}
