/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=packages/gatekeeper-ogc/wrangler.jsonc packages/gatekeeper-ogc/worker-configuration.d.ts` (hash: a8fc56d26e707e820a92dea23ec36298)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OGC_ALLOWED_HOSTS">> {}
}
