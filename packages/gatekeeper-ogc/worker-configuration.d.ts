/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=packages/gatekeeper-ogc/wrangler.jsonc packages/gatekeeper-ogc/worker-configuration.d.ts` (hash: d3136cbe8f12cf74bd7d7d2b444099cf)
// Runtime types generated with workerd@1.20260903.1 2026-09-09 nodejs_compat
interface __BaseEnv_Env {
	OGC_ALLOWED_HOSTS: "ogcapi.dgterritorio.gov.pt";
}
