/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=packages/gatekeeper-ren/wrangler.jsonc packages/gatekeeper-ren/worker-configuration.d.ts` (hash: 7fcadbe02098c7a4bfef1465d5dbba66)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "REN_API_ORIGIN" | "REN_DATA_API_ORIGIN">> {}
}
