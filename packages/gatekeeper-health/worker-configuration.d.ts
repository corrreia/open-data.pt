/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=packages/gatekeeper-health/wrangler.jsonc packages/gatekeeper-health/worker-configuration.d.ts` (hash: 17c2cff8bd7c02d9d5e750cc2f1c73bf)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OPENDATASOFT_ALLOWED_HOSTS" | "UDATA_ALLOWED_HOSTS">> {}
}
