/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=packages/gatekeeper-health/wrangler.jsonc packages/gatekeeper-health/worker-configuration.d.ts` (hash: 2eb53e8adc4c70cc5cdc62ea50ed900c)
