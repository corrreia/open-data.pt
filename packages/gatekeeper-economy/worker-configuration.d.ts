/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=packages/gatekeeper-economy/wrangler.jsonc packages/gatekeeper-economy/worker-configuration.d.ts` (hash: 4dff9c7b46f8114f66f89b2d32cc51df)
