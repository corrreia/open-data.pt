/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=packages/gatekeeper-ipma/wrangler.jsonc packages/gatekeeper-ipma/worker-configuration.d.ts` (hash: 8d0dd7b9aaa248d31b3ff25dcfc82094)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "IPMA_API_ORIGIN">> {}
}
