...
describe("public API contract", () => {
  it("is a valid OpenAPI document", async () => {
    ...
    // Validated as it is served at /openapi.json: the JSON text, parsed.
    await expect(SwaggerParser.validate(jsonAs<OpenApiDocument>(JSON.stringify(document)))).resolves.toBeDefined();
    ...
    for (const removed of [
      ...
      "/api/query",
      "/api/products/{slug}/records/asof",
    ])
