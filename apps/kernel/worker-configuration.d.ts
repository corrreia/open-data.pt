/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/kernel/wrangler.jsonc apps/kernel/worker-configuration.d.ts` (hash: 6450265b2a70858c7ba18c471e290756)
