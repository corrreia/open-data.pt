/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/kernel/wrangler.jsonc apps/kernel/worker-configuration.d.ts` (hash: 031d5ca1c01d06dc7e17dd6355255810)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_ACCOUNT_ID" | "LAKE_BUCKET" | "CATALOG_TOKEN">> {}
}
