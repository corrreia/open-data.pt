/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/kernel/wrangler.jsonc apps/kernel/worker-configuration.d.ts` (hash: 5dc1e7fa57c72b691e9bc98740d58f87)
// Runtime types generated with workerd@1.20260921.1 2026-09-09 nodejs_compat
interface __BaseEnv_Env {
	...
	GATEKEEPER: Fetcher /* open-data-pt-gatekeeper */;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_ACCOUNT_ID" | "LAKE_BUCKET" | "DEV_MIN_CADENCE_SECONDS" | "CATALOG_TOKEN" | "ANALYTICS_TOKEN">> {}
}
