/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/kernel/wrangler.jsonc apps/kernel/worker-configuration.d.ts` (hash: 31ab09b1c81137245398765d4aeda6cc)
// Runtime types generated with workerd@1.20260903.1 2026-09-09 nodejs_compat
interface __BaseEnv_Env {
	DATA_OBJECTS: R2Bucket;
	API_RATE_LIMIT: RateLimit;
	HISTORY_RATE_LIMIT: RateLimit;
	MCP_RATE_LIMIT: RateLimit;
	LOADER: WorkerLoader;
	ASSETS: Fetcher;
	LAKE_RECORDS: import("cloudflare:pipelines").Pipeline<Cloudflare.OpenDataV2RecordsRecord>;
	LAKE_POINTS: import("cloudflare:pipelines").Pipeline<Cloudflare.OpenDataV2PointsRecord>;
	...
	FeedRunner: DurableObjectNamespace<import("./src/index").FeedRunner>;
	GATEKEEPER_ARCGIS: Fetcher /* open-data-pt-gatekeeper-arcgis */;
	GATEKEEPER_BPSTAT: Fetcher /* open-data-pt-gatekeeper-bpstat */;
	GATEKEEPER_CARRIS: Fetcher /* open-data-pt-gatekeeper-carris */;
	GATEKEEPER_CKAN: Fetcher /* open-data-pt-gatekeeper-ckan */;
	GATEKEEPER_DGEG: Fetcher /* open-data-pt-gatekeeper-dgeg */;
	GATEKEEPER_EUROSTAT: Fetcher /* open-data-pt-gatekeeper-eurostat */;
	GATEKEEPER_GBFS: Fetcher /* open-data-pt-gatekeeper-gbfs */;
	GATEKEEPER_GTFS: Fetcher /* open-data-pt-gatekeeper-gtfs */;
	GATEKEEPER_INE: Fetcher /* open-data-pt-gatekeeper-ine */;
	GATEKEEPER_IPMA: Fetcher /* open-data-pt-gatekeeper-ipma */;
	GATEKEEPER_METROLISBOA: Fetcher /* open-data-pt-gatekeeper-metrolisboa */;
	GATEKEEPER_OGC: Fetcher /* open-data-pt-gatekeeper-ogc */;
	GATEKEEPER_OMIE: Fetcher /* open-data-pt-gatekeeper-omie */;
	GATEKEEPER_OPENDATASOFT: Fetcher /* open-data-pt-gatekeeper-opendatasoft */;
	GATEKEEPER_PARLIAMENT: Fetcher /* open-data-pt-gatekeeper-parliament */;
	GATEKEEPER_REN: Fetcher /* open-data-pt-gatekeeper-ren */;
	GATEKEEPER_UDATA: Fetcher /* open-data-pt-gatekeeper-udata */;
	COLLECTIONS: Workflow<Parameters<import("./src/index").CollectionWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Registry" | "FeedRunner";
	}
	type OpenDataV2RecordsRecord = { batch_id: string; revision_id: string; feed_id: string; product_slug: string; product_version: number; normalizer_id: string; normalizer_version: string; schema: Record<string, unknown>; entity_key: string; operation: string; identity?: Record<string, unknown>; event_time?: string | number; valid_from?: string | number; valid_to?: string | number; source_published_at?: string | number; observed_at: string | number; ingested_at: string | number; acquisition_id: string; payload: Record<string, unknown> };
	type OpenDataV2PointsRecord = { batch_id: string; revision_id: string; feed_id: string; product_slug: string; normalizer_id: string; normalizer_version: string; schema: Record<string, unknown>; series_key: string; event_time: string | number; value: number; unit: string; dimensions: Record<string, unknown>; observed_at: string | number; acquisition_id: string };
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_ACCOUNT_ID" | "LAKE_BUCKET">> {}
}
