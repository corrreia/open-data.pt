/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/kernel/wrangler.jsonc apps/kernel/worker-configuration.d.ts` (hash: ae0e621a2c2173286d5b3497ffe28890)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_ACCOUNT_ID" | "LAKE_BUCKET" | "CATALOG_TOKEN" | "ANALYTICS_TOKEN">> {}
}
