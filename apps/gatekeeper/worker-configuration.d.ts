/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/gatekeeper/wrangler.jsonc apps/gatekeeper/worker-configuration.d.ts` (hash: 884b7a29492f636ea9c75c1de4e3214b)
// Runtime types generated with workerd@1.20260921.1 2026-09-09 nodejs_compat
interface __BaseEnv_Env {
	PARLIAMENT_STAGING: R2Bucket;
	GATEKEEPER_LIBRARIES: "";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GATEKEEPER_LIBRARIES" | "ML_CONSUMER_KEY" | "ML_CONSUMER_SECRET" | "NASA_FIRMS_MAP_KEY">> {}
}
