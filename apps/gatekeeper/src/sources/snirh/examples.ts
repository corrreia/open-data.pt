...
const SERVING = { licence: "snirh-terms", attribution: "SNIRH — Sistema Nacional de Informação de Recursos Hídricos, APA" } as const;
...
function reading(slug: string, name: SnirhReadingName, policy: ExampleFeed["policy"], topics: string[]): ExampleFeed {
...
export const SNIRH_EXAMPLES: ExampleFeed[] = [
  reading("snirh-river-levels-feed", "river-level", HOURLY_POLICY, ["environment"]),
  reading("snirh-river-flows-feed", "river-flow", DAILY_POLICY, ["environment"]),
  reading("snirh-reservoir-storage-feed", "reservoir-volume", DAILY_POLICY, ["environment"]),
  reading("snirh-reservoir-levels-feed", "reservoir-level", DAILY_POLICY, ["environment"]),
  reading("snirh-precipitation-feed", "precipitation", HOURLY_POLICY, ["weather", "environment"]),
  reading("snirh-air-temperature-feed", "air-temperature", HOURLY_POLICY, ["weather"]),
  reading("snirh-relative-humidity-feed", "relative-humidity", HOURLY_POLICY, ["weather"]),
  reading("snirh-wind-speed-feed", "wind-speed", HOURLY_POLICY, ["weather"]),
  reading("snirh-groundwater-levels-feed", "groundwater-level", MONTHLY_POLICY, ["environment"]),
  {
