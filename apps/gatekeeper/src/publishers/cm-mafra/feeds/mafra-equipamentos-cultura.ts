...
export const FEED = defineFeed(ARCGIS_DEPLOYMENT, {
  slug: "mafra-equipamentos-cultura-feed",
  ...
  config: {
    ...
    service: "arcgisext/rest/services/Dados_Abertos/DadosAbertos_Equipamentos_Coletivos_Cultura/FeatureServer",
    layer: "0",
  },
  policy: MAFRA_POLICY,
  staleAfterSeconds: 172_800,
  /** Once a day: layer 0 of the DadosAbertos_Equipamentos_Coletivos_Cultura FeatureServer on geomafra.cm-mafra.pt — its metadata, then, when it has moved, every feature page by page. */
