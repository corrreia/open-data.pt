...
export const FEED = defineFeed(ARCGIS_DEPLOYMENT, {
  ...
  config: {
    ...
    service: "arcgisext/rest/services/Dados_Abertos/DadosAbertos_Tur_Praias/FeatureServer",
    layer: "0",
  },
  policy: MAFRA_POLICY,
  staleAfterSeconds: 172_800,
  /** Once a day: layer 0 of the DadosAbertos_Tur_Praias FeatureServer on geomafra.cm-mafra.pt — its metadata, then, when it has moved, every feature page by page. */
