...
export const FEED = defineFeed(ARCGIS_DEPLOYMENT, {
  slug: "mafra-equipamentos-escolares-feed",
  config: {
    host: "geomafra.cm-mafra.pt",
    service: "arcgisext/rest/services/Dados_Abertos/DadosAbertos_Educa_Equip_Escolares/FeatureServer",
    layer: "0",
  },
  policy: MAFRA_POLICY,
  staleAfterSeconds: 172_800,
  /** Once a day: layer 0 of the DadosAbertos_Educa_Equip_Escolares FeatureServer on geomafra.cm-mafra.pt — its metadata, then, when it has moved, every feature page by page. */
