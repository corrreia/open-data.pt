...
export const FEED = defineFeed(ARCGIS_DEPLOYMENT, {
  slug: "mafra-circuitos-pedestres-btt-feed",
  config: {
    host: "geomafra.cm-mafra.pt",
    service: "arcgisext/rest/services/Dados_Abertos/DadosAbertos_Desp_CircuitosPedestres_BTT/FeatureServer",
    layer: "0",
  },
  policy: MAFRA_POLICY,
  staleAfterSeconds: 172_800,
  /** Once a day: layer 0 of the DadosAbertos_Desp_CircuitosPedestres_BTT FeatureServer on geomafra.cm-mafra.pt — its metadata, then, when it has moved, every feature page by page. */
