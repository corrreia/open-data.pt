...
export const FEED = defineFeed(ARCGIS_DEPLOYMENT, {
  slug: "mafra-patrimonio-inventario-feed",
  config: {
    host: "geomafra.cm-mafra.pt",
    service: "arcgisext/rest/services/Dados_Abertos/DadosAbertos_Cult_Patrimonio_Inventario_Total/FeatureServer",
    layer: "0",
  },
  policy: MAFRA_POLICY,
  staleAfterSeconds: 172_800,
  /** Once a day: layer 0 of the DadosAbertos_Cult_Patrimonio_Inventario_Total FeatureServer on geomafra.cm-mafra.pt — its metadata, then, when it has moved, every feature page by page. */
