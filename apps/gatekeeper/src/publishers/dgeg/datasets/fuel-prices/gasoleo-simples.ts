...
export const FEED = defineFeed(DGEG_DEPLOYMENT, {
  ...
  config: { feed: "fuel-prices", fuelTypeId: "2101" },
  policy: HOURLY_PRICES,
  staleAfterSeconds: 7_200,
  /** Every hour: every mainland station's current gasóleo simples price, from DGEG's price search, district by district. */
