...
export const FEED = defineFeed(GBFS_DEPLOYMENT, {
  slug: "bird-braga-reference",
  title: "Bird stations and system information in Braga",
  description: "Where every Bird station in Braga is, what it is called, how much it holds, and who operates the system.",
  config: { url: "https://mds.bird.co/gbfs/v2/public/braga/gbfs.json", language: "en", feed: "reference" },
  policy: REFERENCE_POLICY,
  staleAfterSeconds: 172_800,
  /** Once a day: Bird Braga's GBFS discovery document, then the system and station-information files it names. */
