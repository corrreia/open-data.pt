...
export const FEED = defineFeed(GBFS_DEPLOYMENT, {
  ...
  config: {
    url: "https://mds.bird.co/gbfs/v2/public/matosinhos/gbfs.json",
    language: "en",
    feed: "status",
  },
  policy: BIRD_POLICY,
  staleAfterSeconds: 900,
  /** Every five minutes: Bird Matosinhos's GBFS discovery document, then the system, vehicle-type, vehicle and station-status files it names. */
