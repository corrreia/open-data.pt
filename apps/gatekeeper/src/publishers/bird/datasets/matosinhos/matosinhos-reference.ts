...
export const FEED = defineFeed(GBFS_DEPLOYMENT, {
  slug: "bird-matosinhos-reference",
  title: "Bird stations and system information in Matosinhos",
  description: "Where every Bird station in Matosinhos is, what it is called, how much it holds, and who operates the system.",
  config: { url: "https://mds.bird.co/gbfs/v2/public/matosinhos/gbfs.json", language: "en", feed: "reference" },
  policy: REFERENCE_POLICY,
  staleAfterSeconds: 172_800,
  /** Once a day: Bird Matosinhos's GBFS discovery document, then the system and station-information files it names. */
