...
export const FEED = defineFeed(GBFS_DEPLOYMENT, {
  slug: "bird-lisbon-reference",
  title: "Bird stations and system information in Lisbon",
  description: "Where every Bird station in Lisbon is, what it is called, how much it holds, and who operates the system.",
  licence: "source-terms",
  attribution: "The GBFS system operator",
  topics: ["mobility"],
  config: { url: "https://mds.bird.co/gbfs/v2/public/lisbon/gbfs.json", language: "en", feed: "reference" },
  policy: REFERENCE_POLICY,
  staleAfterSeconds: 172_800,
  /** Once a day: Bird Lisbon's GBFS discovery document, then the system and station-information files it names. */
