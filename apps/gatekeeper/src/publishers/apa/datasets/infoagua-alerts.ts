...
export const DATASET: DatasetDefinition = {
  ...
  feeds: [
    ...
    },
    {
      ...
      description:
        "The monthly hydrological drought index and state of each river basin, as APA's InfoÁgua publishes it: wet, normal, or a hydrological drought of rising severity.",
