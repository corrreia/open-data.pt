...
export const FEED = defineFeed(ARCGIS_DEPLOYMENT, {
  slug: "apa-seveso-establishments-feed",
  config: {
    host: "sniambgeoogc.apambiente.pt",
    service: "getogc/rest/services/SNIAmb/Prevencao_Acidentes_Graves/MapServer",
    layer: "0",
  },
  policy: APA_POLICY,
  staleAfterSeconds: 172_800,
  /** Once a day: layer 0 of the Prevencao_Acidentes_Graves MapServer on sniambgeoogc.apambiente.pt — its metadata, then, when it has moved, every feature page by page. */
