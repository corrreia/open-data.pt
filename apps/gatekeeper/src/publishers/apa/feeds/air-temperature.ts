...
export const FEED = defineFeed(SNIRH_DEPLOYMENT, {
  slug: "snirh-air-temperature-feed",
  title: "Portugal hourly air temperature",
  description: "Hourly air temperature at SNIRH meteorological stations. Readings come from SNIRH's station database, usually within a day of being taken.",
  licence: "snirh-terms",
  attribution: "SNIRH — Sistema Nacional de Informação de Recursos Hídricos, APA",
  topics: ["environment", "weather"],
  config: { feed: "readings", reading: "air-temperature" },
  policy: SNIRH_HOURLY_POLICY,
  staleAfterSeconds: 172_800,
  /** Every hour: the air temperature readings SNIRH's station database exports, from the last one this feed saw. */
