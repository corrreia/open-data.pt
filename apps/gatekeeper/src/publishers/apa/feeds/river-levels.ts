...
export const FEED = defineFeed(SNIRH_DEPLOYMENT, {
  ...
  description:
    "Instantaneous water level at SNIRH hydrometric stations, in metres above each station's gauge zero: hourly, and every 5 to 15 minutes at some stations or in a flood. Readings come from SNIRH's station database, usually within a day of being taken.",
  licence: "snirh-terms",
  ...
  /** Every hour: the river level readings SNIRH's station database exports, from the last one this feed saw. */
