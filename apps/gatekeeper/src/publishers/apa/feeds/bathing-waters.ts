...
export const FEED = defineFeed(ARCGIS_DEPLOYMENT, {
  ...
  config: {
    ...
    service: "getogc/rest/services/SNIAmb/Aguas_Balneares/MapServer",
    layer: "0",
  },
  policy: APA_POLICY,
  staleAfterSeconds: 172_800,
  /** Once a day: layer 0 of the Aguas_Balneares MapServer on sniambgeoogc.apambiente.pt — its metadata, then, when it has moved, every feature page by page. */
