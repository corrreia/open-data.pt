...
export const FEED = defineFeed(ARCGIS_DEPLOYMENT, {
  ...
  config: {
    ...
    service: "getogc/rest/services/SNIAmb/Marcas_cheias/MapServer",
    layer: "0",
  },
  policy: APA_POLICY,
  staleAfterSeconds: 172_800,
  /** Once a day: layer 0 of the Marcas_cheias MapServer on sniambgeoogc.apambiente.pt — its metadata, then, when it has moved, every feature page by page. */
