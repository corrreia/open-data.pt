...
export const FEED = defineFeed(ARCGIS_DEPLOYMENT, {
  slug: "apa-meteorological-stations-feed",
  ...
  config: {
    ...
    service: "getogc/rest/services/SNIAmb/Estacoes_meteorologicas/MapServer",
    layer: "0",
  },
  policy: APA_POLICY,
  staleAfterSeconds: 172_800,
  /** Once a day: layer 0 of the Estacoes_meteorologicas MapServer on sniambgeoogc.apambiente.pt — its metadata, then, when it has moved, every feature page by page. */
