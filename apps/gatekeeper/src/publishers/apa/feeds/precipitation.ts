...
export const FEED = defineFeed(SNIRH_DEPLOYMENT, {
  ...
  description: "Hourly precipitation at SNIRH meteorological stations. Readings come from SNIRH's station database, usually within a day of being taken.",
  licence: "snirh-terms",
  ...
  /** Every hour: the precipitation readings SNIRH's station database exports, from the last one this feed saw. */
