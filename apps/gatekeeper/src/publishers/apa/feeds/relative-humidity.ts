...
export const FEED = defineFeed(SNIRH_DEPLOYMENT, {
  slug: "snirh-relative-humidity-feed",
  title: "Portugal hourly relative humidity",
  description: "Hourly relative humidity at SNIRH meteorological stations. Readings come from SNIRH's station database, usually within a day of being taken.",
  licence: "snirh-terms",
  attribution: "SNIRH — Sistema Nacional de Informação de Recursos Hídricos, APA",
  topics: ["environment", "weather"],
  config: { feed: "readings", reading: "relative-humidity" },
  policy: SNIRH_HOURLY_POLICY,
  staleAfterSeconds: 172_800,
  /** Every hour: the relative humidity readings SNIRH's station database exports, from the last one this feed saw. */
