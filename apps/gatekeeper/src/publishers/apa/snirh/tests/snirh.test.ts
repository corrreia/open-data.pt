...
} from "#/publishers/apa/snirh/index";
import { feedCollection, feedsOf } from "#/tests/catalog";

const fixture = (name: string): Uint8Array => readFixtureBytes(new URL(`./fixtures/${name}`, import.meta.url));
...
describe("SNIRH live readings", () => {
  ...
  it("logs what the page refusing a request said", async () => {
