...
export const FEED = defineFeed(IODA_DEPLOYMENT, {
  slug: "ioda-vodafone-as12353-internet-signals-feed",
  title: "Vodafone Portugal AS12353 internet connectivity signals",
  description:
    "IODA's connectivity measurements for AS12353, whose holder IODA reports as VODAFONE-PT: /24 blocks visible in BGP, /24 blocks answering active probes, and unique source IPs reaching the Merit network telescope. This one AS is not every network the operator runs, and a measurement gap is left out rather than published as a zero. Not a speed, quality or customer-availability report.",
  config: { feed: "signals", entityType: "asn", entityCode: "12353", hours: "3" },
  policy: IODA_SIGNAL_POLICY,
  staleAfterSeconds: 10_800,
  /** Every hour: IODA's raw connectivity signals for AS12353 over the past three hours. */
