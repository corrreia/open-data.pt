...
export const FEED = defineFeed(IODA_DEPLOYMENT, {
  slug: "ioda-nos-madeira-as15457-internet-signals-feed",
  title: "NOS Madeira AS15457 internet connectivity signals",
  description:
    "IODA's connectivity measurements for AS15457, whose holder IODA reports as NOS_MADEIRA: /24 blocks visible in BGP, /24 blocks answering active probes, and unique source IPs reaching the Merit network telescope. This one AS is not every network the operator runs, and a measurement gap is left out rather than published as a zero. Not a speed, quality or customer-availability report.",
  config: { feed: "signals", entityType: "asn", entityCode: "15457", hours: "3" },
  policy: IODA_SIGNAL_POLICY,
  staleAfterSeconds: 10_800,
  /** Every hour: IODA's raw connectivity signals for AS15457 over the past three hours. */
