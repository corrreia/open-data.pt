...
function network(slug: string, title: string, asn: string): FeedDefinition {
...
function iodaFeed(slug: string, title: string, description: string, config: SourceConfig, cadenceSeconds: number): FeedDefinition {
  return {
    slug,
    title,
    description,
