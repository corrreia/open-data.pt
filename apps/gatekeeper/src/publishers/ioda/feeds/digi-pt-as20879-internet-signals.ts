...
export const FEED = defineFeed(IODA_DEPLOYMENT, {
  slug: "ioda-digi-pt-as20879-internet-signals-feed",
  title: "DIGI Portugal AS20879 internet connectivity signals",
  description:
    "IODA's connectivity measurements for AS20879, whose holder IODA reports as DIGI-PT: /24 blocks visible in BGP, /24 blocks answering active probes, and unique source IPs reaching the Merit network telescope. This one AS is not every network the operator runs, and a measurement gap is left out rather than published as a zero. Not a speed, quality or customer-availability report.",
  licence: "ioda-all-rights-reserved",
  attribution: "IODA, Internet Intelligence Lab, Georgia Institute of Technology",
  topics: ["telecom"],
  config: { feed: "signals", entityType: "asn", entityCode: "20879", hours: "3" },
  policy: IODA_SIGNAL_POLICY,
  staleAfterSeconds: 10_800,
  /** Every hour: IODA's raw connectivity signals for AS20879 over the past three hours. */
