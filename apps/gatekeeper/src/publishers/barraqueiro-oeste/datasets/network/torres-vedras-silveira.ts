...
export const FEED = defineFeed(MYINFO_DEPLOYMENT, {
  slug: "barraqueiro-oeste-torres-vedras-silveira-feed",
  title: "Torres Vedras to Silveira departures",
  description: "Every scheduled Barraqueiro Oeste departure from Torres Vedras to Silveira, with its arrival, journey time, lines and the days it runs.",
  config: { feed: "timetable", operator: "BarraqueiroOeste", origin: "4384", destination: "4377" },
