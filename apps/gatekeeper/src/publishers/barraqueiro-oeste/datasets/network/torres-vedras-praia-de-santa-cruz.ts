...
export const FEED = defineFeed(MYINFO_DEPLOYMENT, {
  slug: "barraqueiro-oeste-torres-vedras-praia-de-santa-cruz-feed",
  title: "Torres Vedras to Praia de Santa Cruz departures",
  description: "Every scheduled Barraqueiro Oeste departure from Torres Vedras to Praia de Santa Cruz, with its arrival, journey time, lines and the days it runs.",
  config: { feed: "timetable", operator: "BarraqueiroOeste", origin: "4384", destination: "4364" },
