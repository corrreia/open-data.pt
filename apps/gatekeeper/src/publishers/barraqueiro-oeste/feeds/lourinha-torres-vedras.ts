...
export const FEED = defineFeed(MYINFO_DEPLOYMENT, {
  slug: "barraqueiro-oeste-lourinha-torres-vedras-feed",
  title: "Lourinhã to Torres Vedras departures",
  description: "Every scheduled Barraqueiro Oeste departure from Lourinhã to Torres Vedras, with its arrival, journey time, lines and the days it runs.",
  licence: "source-terms",
  attribution: "Barraqueiro Oeste via myinfo.4cloud.pt",
  topics: ["mobility"],
  config: { feed: "timetable", operator: "BarraqueiroOeste", origin: "4329", destination: "4384" },
