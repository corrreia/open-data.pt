...
export const FEED = defineFeed(MYINFO_DEPLOYMENT, {
  slug: "barraqueiro-oeste-torres-vedras-turcifal-feed",
  title: "Torres Vedras to Turcifal departures",
  description: "Every scheduled Barraqueiro Oeste departure from Torres Vedras to Turcifal, with its arrival, journey time, lines and the days it runs.",
  licence: "source-terms",
  attribution: "Barraqueiro Oeste via myinfo.4cloud.pt",
  topics: ["mobility"],
  config: { feed: "timetable", operator: "BarraqueiroOeste", origin: "4384", destination: "4385" },
