...
export const FEED = defineFeed(MYINFO_DEPLOYMENT, {
  slug: "barraqueiro-oeste-torres-vedras-a-dos-cunhados-feed",
  title: "Torres Vedras to A dos Cunhados departures",
  description: "Every scheduled Barraqueiro Oeste departure from Torres Vedras to A dos Cunhados, with its arrival, journey time, lines and the days it runs.",
  licence: "source-terms",
  attribution: "Barraqueiro Oeste via myinfo.4cloud.pt",
  topics: ["mobility"],
  config: { feed: "timetable", operator: "BarraqueiroOeste", origin: "4384", destination: "4263" },
