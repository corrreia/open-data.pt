...
export const FEED = defineFeed(NASA_POWER_DEPLOYMENT, {
  slug: "nasa-power-madeira-solar-resource-feed",
  title: "Daily solar resource around Madeira",
  description:
    "NASA POWER daily all-sky surface shortwave irradiance on its source grid for the Madeira bounding region, published here after a 90-day settling lag. A bounding rectangle may include nearby land or ocean outside Portugal.",
  config: { feed: "daily-region", region: "madeira", parameter: "ALLSKY_SFC_SW_DWN", days: "30" },
  policy: NASA_POWER_POLICY,
  staleAfterSeconds: 1_209_600,
  /** Once a week: POWER's daily regional analysis of the last 30 settled days over the bounding box around Madeira. */
