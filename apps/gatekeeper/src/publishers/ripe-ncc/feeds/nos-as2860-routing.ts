...
export const FEED = defineFeed(RIPESTAT_DEPLOYMENT, {
  ...
  title: "NOS AS2860 routing",
  description:
    "RIPE RIS routing counts for AS2860 at every eight-hour snapshot: the RIS peers seeing it, its announced prefixes and address space, and its observed neighbours. Holder verified through RIPE as-overview as NOS_COMUNICACOES NOS COMUNICACOES, S.A.. This one AS does not represent every network of the operator or exclusively Portuguese routes. Visibility uses the ten-full-feed-peer threshold and IPv6 space is measured in /48 subnet equivalents, not individual addresses. RIPE's snapshots are at 00:00, 08:00 and 16:00 UTC; this is not an ISP outage, speed or customer-availability report.",
