...
export const FEED = defineFeed(REN_DEPLOYMENT, {
  slug: "ren-renewables-share-feed",
  title: "REN renewable and non-renewable electricity",
  description: "Quarter-hour renewable generation, non-renewable generation, consumption, and import balance.",
  config: { service: "renewables-share" },
  policy: REN_ELECTRICITY_POLICY,
  staleAfterSeconds: 3600,
  /** Every half hour: the Data Hub's renewable and non-renewable generation chart, for yesterday and, once the day is six hours old, today. */
