...
export const FEED = defineFeed(REN_DEPLOYMENT, {
  slug: "ren-gas-consumption-feed",
  title: "REN natural gas consumption",
  description: "Hourly natural gas consumption by major customer group.",
  licence: "ren-datahub",
  attribution: "REN — Redes Energéticas Nacionais",
  topics: ["energy"],
  config: { service: "gas-consumption" },
  policy: REN_GAS_POLICY,
  staleAfterSeconds: 3600,
  /** Every hour: the Data Hub's gas consumption chart, for yesterday and, once the day is six hours old, today. */
