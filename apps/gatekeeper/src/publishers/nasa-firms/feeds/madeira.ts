...
export const FEED = defineFeed(FIRMS_DEPLOYMENT, {
  slug: "nasa-firms-madeira-thermal-anomalies-feed",
  title: "NASA FIRMS thermal anomalies around Madeira",
  description:
    "VIIRS Suomi-NPP near-real-time thermal-anomaly pixels detected during the past 5 days in the Madeira bounding region. A pixel is not a confirmed wildfire, exact ignition point or burnt-area perimeter.",
  licence: "nasa-earthdata",
  attribution: "NASA FIRMS, part of NASA's Earth Science Data and Information System (ESDIS)",
  topics: ["environment"],
  config: { feed: "hotspots", region: "madeira", product: "VIIRS_SNPP_NRT" },
  policy: FIRMS_POLICY,
  staleAfterSeconds: 21_600,
  /** Every three hours: FIRMS's area CSV of VIIRS Suomi-NPP pixels over the past days in the bounding box around Madeira, asked with the map key. */
