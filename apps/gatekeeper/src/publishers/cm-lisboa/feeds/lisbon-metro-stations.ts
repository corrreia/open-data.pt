...
export const FEED = defineFeed(ARCGIS_DEPLOYMENT, {
  slug: "lisbon-metro-stations-feed",
  ...
  config: {
    ...
    service: "1dSrzEWVQn5kHHyK/arcgis/rest/services/POITransportes/FeatureServer",
    layer: "1",
  },
  policy: LISBON_POLICY,
  staleAfterSeconds: 172_800,
  /** Once a day: layer 1 of the POITransportes FeatureServer on services.arcgis.com — its metadata, then, when it has moved, every feature page by page. */
