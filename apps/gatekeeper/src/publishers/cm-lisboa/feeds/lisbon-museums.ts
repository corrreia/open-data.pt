...
export const FEED = defineFeed(ARCGIS_DEPLOYMENT, {
  ...
  config: {
    ...
    service: "1dSrzEWVQn5kHHyK/arcgis/rest/services/POICultura/FeatureServer",
    layer: "3",
  },
  policy: LISBON_POLICY,
  staleAfterSeconds: 172_800,
  /** Once a day: layer 3 of the POICultura FeatureServer on services.arcgis.com — its metadata, then, when it has moved, every feature page by page. */
