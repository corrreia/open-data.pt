...
export const FEED = defineFeed(ARCGIS_DEPLOYMENT, {
  slug: "lisbon-tree-incidents-feed",
  ...
  config: {
    ...
    service: "1dSrzEWVQn5kHHyK/arcgis/rest/services/Incidentes_Arv/FeatureServer",
    layer: "0",
  },
  policy: LISBON_POLICY,
  staleAfterSeconds: 172_800,
  /** Once a day: layer 0 of the Incidentes_Arv FeatureServer on services.arcgis.com — its metadata, then, when it has moved, every feature page by page. */
