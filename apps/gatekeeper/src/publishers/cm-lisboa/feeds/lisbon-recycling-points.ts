...
export const FEED = defineFeed(ARCGIS_DEPLOYMENT, {
  slug: "lisbon-recycling-points-feed",
  ...
  config: {
    ...
    service: "1dSrzEWVQn5kHHyK/arcgis/rest/services/Amb_Reciclagem/FeatureServer",
    layer: "2",
  },
  policy: LISBON_UNSTATED_POLICY,
  staleAfterSeconds: 172_800,
  /** Once a day: layer 2 of the Amb_Reciclagem FeatureServer on services.arcgis.com — its metadata, then, when it has moved, every feature page by page. */
