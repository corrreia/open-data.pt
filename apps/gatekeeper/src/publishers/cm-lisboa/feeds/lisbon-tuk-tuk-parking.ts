...
export const FEED = defineFeed(ARCGIS_DEPLOYMENT, {
  slug: "lisbon-tuk-tuk-parking-feed",
  ...
  config: {
    ...
    service: "1dSrzEWVQn5kHHyK/arcgis/rest/services/TukTukEstacionamentos/FeatureServer",
    layer: "0",
  },
  policy: LISBON_POLICY,
  staleAfterSeconds: 172_800,
  /** Once a day: layer 0 of the TukTukEstacionamentos FeatureServer on services.arcgis.com — its metadata, then, when it has moved, every feature page by page. */
