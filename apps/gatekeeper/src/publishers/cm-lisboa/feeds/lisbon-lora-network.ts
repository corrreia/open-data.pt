...
export const FEED = defineFeed(ARCGIS_DEPLOYMENT, {
  ...
  config: {
    ...
    service: "1dSrzEWVQn5kHHyK/arcgis/rest/services/Rede_LoRa/FeatureServer",
    layer: "0",
  },
  policy: LISBON_POLICY,
  staleAfterSeconds: 172_800,
  /** Once a day: layer 0 of the Rede_LoRa FeatureServer on services.arcgis.com — its metadata, then, when it has moved, every feature page by page. */
