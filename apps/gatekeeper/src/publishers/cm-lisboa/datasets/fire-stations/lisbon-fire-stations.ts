...
export const FEED = defineFeed(ARCGIS_DEPLOYMENT, {
  slug: "lisbon-fire-stations-feed",
  config: {
    host: "services.arcgis.com",
    service: "1dSrzEWVQn5kHHyK/arcgis/rest/services/POISocorro/FeatureServer",
    layer: "1",
  },
  policy: LISBON_POLICY,
  staleAfterSeconds: 172_800,
  /** Once a day: layer 1 of the POISocorro FeatureServer on services.arcgis.com — its metadata, then, when it has moved, every feature page by page. */
