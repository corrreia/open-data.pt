...
export const FEED = defineFeed(ARCGIS_DEPLOYMENT, {
  ...
  config: {
    ...
    service: "1dSrzEWVQn5kHHyK/arcgis/rest/services/EquipamentosCulturais/FeatureServer",
    layer: "1",
  },
  policy: LISBON_UNSTATED_POLICY,
  staleAfterSeconds: 172_800,
  /** Once a day: layer 1 of the EquipamentosCulturais FeatureServer on services.arcgis.com — its metadata, then, when it has moved, every feature page by page. */
