...
export const FEED = defineFeed(ARCGIS_DEPLOYMENT, {
  ...
  config: {
    ...
    service: "1dSrzEWVQn5kHHyK/arcgis/rest/services/UCT_OcupacoesTemporariasEspacoPublico/FeatureServer",
    layer: "0",
  },
  policy: LISBON_UNSTATED_POLICY,
  staleAfterSeconds: 172_800,
  /** Once a day: layer 0 of the UCT_OcupacoesTemporariasEspacoPublico FeatureServer on services.arcgis.com — its metadata, then, when it has moved, every feature page by page. */
