...
export const FEED = defineFeed(ARCGIS_DEPLOYMENT, {
  slug: "lisbon-sports-facilities-feed",
  config: {
    host: "services.arcgis.com",
    service: "1dSrzEWVQn5kHHyK/arcgis/rest/services/Desporto_Instalacoes/FeatureServer",
    layer: "0",
  },
  policy: LISBON_POLICY,
  staleAfterSeconds: 172_800,
  /** Once a day: layer 0 of the Desporto_Instalacoes FeatureServer on services.arcgis.com — its metadata, then, when it has moved, every feature page by page. */
