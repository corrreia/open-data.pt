...
export const FEED = defineFeed(WFS_DEPLOYMENT, {
  ...
  config: {
    ...
    typeName: "caop_raa:raa_cen_ori_freguesias",
    idField: "@id",
    srsName: "EPSG:4326",
  ...
  /** Once a week: every feature of caop_raa:raa_cen_ori_freguesias on geo2.dgterritorio.gov.pt, page by page, as GeoJSON. */
