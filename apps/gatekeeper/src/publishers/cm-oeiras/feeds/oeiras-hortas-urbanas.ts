...
export const FEED = defineFeed(WFS_DEPLOYMENT, {
  ...
  config: {
    ...
    typeName: "dados_abertos:w_hortas_urbanas",
    idField: "nome",
    srsName: "EPSG:4326",
  },
  policy: OEIRAS_POLICY,
  staleAfterSeconds: 172_800,
  /** Once a day: every feature of dados_abertos:w_hortas_urbanas on oeirasinterativa.oeiras.pt, page by page, as GeoJSON. */
