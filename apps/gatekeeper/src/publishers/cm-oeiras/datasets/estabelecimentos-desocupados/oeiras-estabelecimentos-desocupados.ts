...
export const FEED = defineFeed(WFS_DEPLOYMENT, {
  ...
  config: {
    ...
    typeName: "dados_abertos:w_com_serv_estabelecimento_desocupado",
    idField: "cod_estabelecimento",
    srsName: "EPSG:4326",
  },
  policy: OEIRAS_POLICY,
  staleAfterSeconds: 172_800,
  /** Once a day: every feature of dados_abertos:w_com_serv_estabelecimento_desocupado on oeirasinterativa.oeiras.pt, page by page, as GeoJSON. */
