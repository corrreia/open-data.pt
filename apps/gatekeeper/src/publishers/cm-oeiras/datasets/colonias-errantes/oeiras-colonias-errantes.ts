...
export const FEED = defineFeed(WFS_DEPLOYMENT, {
  ...
  config: {
    ...
    typeName: "dados_abertos:w_colonias_errantes",
    idField: "@id",
    srsName: "EPSG:4326",
  },
  policy: OEIRAS_POLICY,
  staleAfterSeconds: 172_800,
  /** Once a day: every feature of dados_abertos:w_colonias_errantes on oeirasinterativa.oeiras.pt, page by page, as GeoJSON. */
