...
export const FEED = defineFeed(WFS_DEPLOYMENT, {
  ...
  config: {
    ...
    typeName: "dados_abertos:w_espacos_verdes",
    idField: "@id",
    srsName: "EPSG:4326",
  ...
  /** Once a day: every feature of dados_abertos:w_espacos_verdes on oeirasinterativa.oeiras.pt, page by page, as GeoJSON. */
